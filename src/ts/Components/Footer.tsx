    ...
    <div className='p-[1rem] bg-[#0096C7] dark:bg-[#7B2CBF] text-[#fff] w-[375px] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1280px] m-auto rounded-t-md flex'>
      ...
      <div className='p-[0.2rem] basis-[50%] sm:basis-[20%] md:basis-[10%] h-full'>
        <ul className='flex list-none'>
          ...
          <li className='basis-[50%] p-2'><a aria-label="check out my portfolio for more projects" href="https://brendon-oneill.ie/" target="_blank" rel="noopener noreferrer"><img width={"30px"} height={"30px"} src={"../images/folder.svg"} alt="" /></a></li>
        </ul>
      </div>
    </div>
  )
