function InfoCard() {
  return (
    <div className="p-[1rem] mx-auto my-2 border-[5px] border-[#023E8A] rounded-[10px]">
        ...
        <p className="border-[#023E8A] rounded-[10px] border-[3px] p-[0.5rem]">The score is caluclated by the coloured cards, green (If you do get the answer correct first try) is 2 marks grey (If you dont get the answer first try) is 1 mark and red or blue is 0 marks.</p>
        <p></p>
      </div>
  )
}
