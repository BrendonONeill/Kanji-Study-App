    ...
    <>
      <div className=" min-h-[95vh] w-[375px] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1280px] m-auto bg-[#FFF5EE] dark:bg-[#2F3037]  flex flex-col">
        ...
        <div className=" p-[2rem]">
          <button aria-label="preview decks" className=" p-[0.8rem] hover:bg-[#b35500] bg-[#FF7900] rounded-[5px] text-[#000] font-bold" onClick={() => navigate(`/cards`)}>Preview Decks</button>
        </div>
        <CardsSelection />
      </div>
      <Footer />
